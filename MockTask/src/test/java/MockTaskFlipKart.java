...
public class MockTaskFlipKart {
	...
	@Test
	public void flightBooking() throws InterruptedException, EncryptedDocumentException, IOException
	
	{
		...
		driver.findElement(By.xpath("//input[@name='0-departcity']")).sendKeys("Bengaluru");
		...
		driver.findElement(By.xpath("//span[.='SEARCH']")).click();
		 List<WebElement> names = driver.findElements(By.xpath("//div[@class='eivht0']/descendant::div[@class='jvoo4s']"));
		 List<WebElement> prices = driver.findElements(By.xpath("//div[@class='eivht0']/descendant::div[@class='O+irE2']"));
		 int rowcoutn=1;
...
//		 FileInputStream fis= new FileInputStream("./src/test/resources/flights.xlsx");
//		 wb = WorkbookFactory.create(fis);
//		 FileOutputStream fos= new FileOutputStream("./src/test/resources/flights.xlsx");
